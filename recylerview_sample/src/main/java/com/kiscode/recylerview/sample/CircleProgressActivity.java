...
public class CircleProgressActivity extends AppCompatActivity {private CircleProgressBar mLineProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomProgressBar5.setProgress(35);
        mCustomProgressBar5.setProgressFormatter(null);
